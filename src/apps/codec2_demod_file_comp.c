//******************************************************************************
/// @file     codec2_demod_file_comp.c
/// @author   Jay Convertino(johnathan.convertino.1@us.af.mil)
/// @date     2023.06.29
/// @brief    Example of codec2 datac1 of file demod of complex floats
//******************************************************************************
...
int main(int argc, char *argv[])
{
  ...
  p_file_func_read_args = create_file_args(p_read_file, DATA_INVALID, DATA_CFLOAT, OVERWRITE_FILE);
  ...
  p_file_read_node = dsp_create(BUFFSIZE, FILECHUNK);
  ...
  p_file_write_node = dsp_create(BUFFSIZE, FILECHUNK);
  ...
  error = dsp_setInput(p_codec2_demod_node, p_file_read_node);
