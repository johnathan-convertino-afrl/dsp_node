//******************************************************************************
/// @file     codec2_demod_file_short.c
/// @author   Jay Convertino(johnathan.convertino.1@us.af.mil)
/// @date     2023.07.15
/// @brief    Example of codec2 datac1 of file demod of short based data.
//******************************************************************************
...
int main(int argc, char *argv[])
{
  ...
  p_file_func_read_args = create_file_args(p_read_file, DATA_INVALID, DATA_S16, OVERWRITE_FILE);
