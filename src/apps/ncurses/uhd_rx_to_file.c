...
int main(int argc, char *argv[])
{
  ...
  //morph base nodes into specific nodes
  ...
  if(!p_uhd_rx_monitor) goto cleanup_write;

  p_file_write_monitor = ncurses_dsp_monitor_create(p_file_write_node, "FILE WRITE");

  if(!p_file_write_monitor) goto cleanup_uhd_mon;
